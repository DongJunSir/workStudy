...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rootRoute = __webpack_require__(159);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _my = __webpack_require__(225);
	...
	var RootRoute = function (_Component) {
	    _inherits(RootRoute, _Component);

	    function RootRoute(props) {
	        _classCallCheck(this, RootRoute);

	        var _this = _possibleConstructorReturn(this, (RootRoute.__proto__ || Object.getPrototypeOf(RootRoute)).call(this, props));

	        _this.state = {};
	        return _this;
	    }

	    _createClass(RootRoute, [{
	        key: 'render',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _headerItem = __webpack_require__(227);
	...
	var f_left = { "float": "left" };
	var f_right = { "float": "right" };

	var leftList = ["豆瓣", "读书", "电影", "音乐", "同城", "小组", "阅读", "FM", "时间", "东西", "市集", "更多"];
	var rightList = ["下载豆瓣客户端", "登录", "注册"];
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "header" },
	                _react2.default.createElement(_headerItem2.default, { links: leftList, style: f_left }),
	                _react2.default.createElement(_headerItem2.default, { links: rightList, style: f_right })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HeaderItem = function (_Component) {
	    _inherits(HeaderItem, _Component);
